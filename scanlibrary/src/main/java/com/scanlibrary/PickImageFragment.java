    ...
    public void openCamera() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            Uri tempFileUri = FileProvider.getUriForFile(getActivity().getApplicationContext(),
                    BuildConfig.APPLICATION_ID + ".provider", // As defined in Manifest
                    file);
            ...
            for (ResolveInfo resolveInfo : resInfoList) {
                ...
                getActivity().grantUriPermission(packageName, tempFileUri, Intent.FLAG_GRANT_WRITE_URI_PERMISSION | Intent.FLAG_GRANT_READ_URI_PERMISSION);
            }
